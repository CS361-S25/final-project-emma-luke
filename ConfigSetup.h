...
EMP_BUILD_CONFIG(MyConfigType,
    VALUE(SEED, int, 9, "What value should the random seed be?"), 
    ...
    VALUE(DESTRUCTION_ROUNDS, int, 10, "Number of rounds to incrementally destroy habitat (0-100, 0=immediate)")
  )